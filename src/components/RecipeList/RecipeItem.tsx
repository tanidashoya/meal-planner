...
export const RecipeItem = ({
  ...
  return (
    <div className="flex items-center cursor-pointer hover:bg-gray-200 pl-10 py-1.5 text-lg text-gray-700">
      {/* truncate:文字が長すぎる場合に省略する。（その場合は…と表示される） */}
      <span className="truncate flex-1" onClick={moveToDetail}>
        {recipe.title}
      </span>
      <Trash2

...
export const BottomBar = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 lg:hidden border-t border-gray-200 bg-white w-full flex justify-center items-center gap-1 h-16 pb-1">
      <Button
        variant="outline"
        className="flex flex-col items-center hover:bg-white !px-3 !py-6 !shadow-none !outline-none focus:!outline-none focus-visible:!outline-none gap-1"
        onClick={() => navigate("/")}
      >
        <PlusCircle
      ...
      <Button
        variant="outline"
        className="flex flex-col items-center hover:bg-white !px-2 !py-6 lg:mt-2 !shadow-none !outline-none focus:!outline-none focus-visible:!outline-none gap-1"
